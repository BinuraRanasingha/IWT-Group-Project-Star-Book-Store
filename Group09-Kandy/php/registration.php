...
<div class="form">
<h3><center> Registration For an Account</center></h3>
<div class="register">
	<div class="form-box"></div>
	</div>

<form action = "signup-check.php" target = "_self" method = "POST"  onsubmit = "return checkPassword()" onclick = "enableButton()">

	<label> Name </label> <br>
	<input type = "text" id = "name" name = "name" required> <br> <br>

	<label> user Name </label> <br>
	<input type = "tect" id = "uname" name = "uname" required> <br> <br>
	

	<label> Gender </label> <br>
	<input type = "radio" id = "gender" name = "gender" checked> Male &nbsp &nbsp 
	<input type = "radio" id = "gender" name = "gender"> Female <br> <br>
	<label> NIC </label> <br>
	<input type = "tel" id = "NIC" name = "NIC" required> <br> <br>

	<label> Mobile Number </label> <br>
	<input type = "tel" id = "mobile" name = "mobile" required> <br> <br>

	<label> E-mail </label> <br>
	<input type = "email" id = "email" name = "email" pattern = "[a-zA-Z0-9._%+-*$]+@+[a-z0-9]+\.[a-z]{2,3}"  required> <br> <br>
	
	<label> Address </label> <br>
	<textarea id = "address" name = "address" style = "width:500px" required> </textarea> <br> <br>
	
	<label> Choose Your DOB </label> <br>
	<select name = "date" id = "date" placeholder = "Choose a Date">
		<option> Date </option> 
		<option> 1 </option> 
		<option> 2 </option>
		<option> 3 </option>
	...
	<select name = "month" id = "month" placeholder = "Choose a Month"> 
		<option> Month </option> 
		<option> 1 </option> 
		<option> 2 </option>
		<option> 3 </option>
	...
	<input type = "password" id="pwd" name = "pwd" pattern = "[a-z]+[A-Z]+[0-9]{5 , 10} "required> <br> <br>
	
	
	<label> Re-enter Password </label> <br>
	<input type = "password" id="rpwd" name = "rpwd" required> <br> <br>

	<input type = "checkbox" id = "policy" name= "policy" required> Accept privacy policy terms <br> <br>
	<div id="cfn"></div>
	<input type = "submit" id = "submit" name = "submit" value = "Sign up" disabled>
