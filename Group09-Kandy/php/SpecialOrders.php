...
.awardBox{
	...
	<!--priority order link-->
	<link rel="stylesheet" type="text/css" href="css/BooklistOrder.css">
...
<div class="orderform">
  ...
  <h4>Fill form for the books which are not available in our online store.We will inform you as soon as possible that whether we can fulfill your requirement or not.</h4>
  
  
  <form action="SpecialOrdersProcess.php" method="post" >
  ...
  <label>Email   </label>
  <input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}" placeholder="abc@gmail.com"> <br><br>
  
  <label>Address</label><br>
  <textarea name="address" rows="6" cols="30" required ></textarea> <br><br>
  
  <label>Enter Book Name </label><br>
  <textarea name="bn" rows="3" cols="30" required></textarea><br><br>
  
  <label>Enter Author Name</label><br><br>
 <textarea name="an" rows="3" cols="30" required></textarea><br><br>
   
   <input type="checkbox" id="check1" onclick="enableButton()" selected>
  <label>Completed</label> <br><br>
  
  <input type="submit" id="btnsub1" value="Submit"  disabled>  <br><br> 
  
</div>   



<!-- priority order form ends-->
